...
if __name__ == '__main__':
    ...
    zero_daughters = [x for x in history.all_characters() if x.is_zero_girl_mom()]

    with_daughters = [x for x in history.all_characters() if x.is_mom_with_girls()]

    survivor_mums = [x for x in history.all_characters() if x.is_surviving_mom()]
